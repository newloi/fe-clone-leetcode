          ...
          <div className="left-side block">
            <div className="tabbar">
              ...
              <div className={`tab ${resultId ? "" : "hidden"}`}>
                <span>|</span>
                <button
                  className={`${tab === "result" ? "active-tab" : ""
                    }`}
                  onClick={() => {
                    setTab("result");
                  }}
            ...
            <div
              className={`container-tab ${tab === "description" ? "" : "hidden"
                }`}
            >
              <Problem problem={data} />
            </div>
            <div
              className={`container-tab ${tab === "solutions" ? "" : "hidden"
                }`}
            >
              <Solutions
            ...
            <div
              className={`container-tab ${tab === "solution" ? "" : "hidden"
                }`}
            >
              <Solution solutionId={solutionId} setTab={setTab} />
            </div>
            <div
              className={`container-tab ${tab === "submissions" ? "" : "hidden"
                }`}
            >
              <Submissions
                problemId={problem.id}
            ...
            <div
              className={`container-tab ${tab === "result" ? "" : "hidden"
                }`}
            >
